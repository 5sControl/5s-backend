...
class CustomUser(models.Model):
    ...
    image1 = models.ImageField(upload_to="", verbose_name='photo below', blank=True, null=True)
    image2 = models.ImageField(upload_to="", verbose_name='photo from above', blank=True, null=True)
    image3 = models.ImageField(upload_to="", verbose_name='photo in the center', blank=True, null=True)
    image4 = models.ImageField(upload_to="", verbose_name='photo on the left', blank=True, null=True)
    image5 = models.ImageField(upload_to="", verbose_name='photo on the right', blank=True, null=True)
