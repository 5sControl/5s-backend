...
ONVIFFINDER_SERVICE_URL = os.environ.get("ONVIFFINDER_SERVICE_URL")
ALGORITHMS_CONTROLLER_SERVICE_URL = os.environ.get("ALGORITHMS_CONTROLLER_SERVICE_URL")
DJANGO_SERVICE_URL = os.environ.get("DJANGO_SERVICE_URL")
SERVER_URL = os.environ.get("SERVER_URL")
print(ALGORITHMS_CONTROLLER_SERVICE_URL, 'ALGORITHMS_CONTROLLER_SERVICE_URLALGORITHMS_CONTROLLER_SERVICE_URLALGORITHMS_CONTROLLER_SERVICE_URLALGORITHMS_CONTROLLER_SERVICE_URLALGORITHMS_CONTROLLER_SERVICE_URLALGORITHMS_CONTROLLER_SERVICE_URLALGORITHMS_CONTROLLER_SERVICE_URLALGORITHMS_CONTROLLER_SERVICE_URLALGORITHMS_CONTROLLER_SERVICE_URLALGORITHMS_CONTROLLER_SERVICE_URLALGORITHMS_CONTROLLER_SERVICE_URL')
